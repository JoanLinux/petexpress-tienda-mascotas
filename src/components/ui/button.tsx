...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-button hover:shadow-primary",
        destructive:
        ...
        hero: "bg-gradient-primary text-white hover:opacity-90 shadow-primary transform hover:scale-105 transition-bounce",
        pet: "bg-gradient-hero text-primary-foreground hover:opacity-95 shadow-card rounded-lg font-semibold",
      },
      size: {
